  ...
  return (
    <div className="footer-wrapper h-[100vh] flex items-center justify-center">
      <div className='grid grid-cols-1 md:grid-cols-2 items-center bg-white rounded-xl py-2 md:p-8'>
        ...
        <div className='hidden md:block col-span-1 flex justify-center md:justify-start'>
          <img
        ...
        <div className='col-span-1  md:px-10 '>
          <form className='flex flex-col items-center justify-center'>
            <h1 className="text-blue-600 text-3xl font-bold mb-2">Sign Up</h1>
            <p className="text-sm mb-5">Already have account ? 
            <button className="px-2 py-1 bg-blue-200 rounded-md text-sm mx-2 hover:bg-blue-500 hover:text-white">Sign In</button></p>
            <input
